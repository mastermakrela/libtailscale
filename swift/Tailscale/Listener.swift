...
/// A TSListener is used to await incoming connections from another
/// Tailnet node.
public actor Listener {
    ...
    /// Closes the listener.  It cannot be restared
    ...
    ///                value of Int32.max and supports millisecond precision per poll(2)
